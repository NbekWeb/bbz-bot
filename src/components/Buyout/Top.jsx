  ...
  return (
    <div className='grid grid-cols-4 gap-6'>
        ...
        <CardContent>
          <Link href='/addbuyout'>
            <div className='flex items-center justify-between'>
              <span className='text-lg font-medium'>Добавить Выкупы</span>
      ...
      <Card>
        <CardContent>
          <div className='flex items-center justify-between'>
            <span className='text-lg font-medium'>Быстро</span>
      ...
      <Card>
        <CardContent>
          <div className='flex items-center justify-between'>
            <span className='text-lg font-medium'>Группы Выкупов</span>
